function playSample(sample) {
    var sound = new Audio("assets/" + sample);
    sound.play();
}
function arrays() {
    var samplenames = ["assets/kick.mp3", "assets/hihat.mp3", "assets/kick.mp3", "assets/hihat.mp3", "assets/kick.mp3", "assets/snare.mp3", "assets/snare.mp3", "assets/snare.mp3", "assets/kick.mp3", "assets/hihat.mp3", "assets/kick.mp3", "assets/hihat.mp3", "assets/kick.mp3", "assets/laugh2.mp3"];
    var index = 0;
